 ...
 */
HaloVoteCard.prototype.onUpdate = function (content, config) {
 ...
 */
HaloVoteCard.prototype.onParse = function (node, parser) {
  // 处理文本标签
  if (node.type === 'text') {
    // node.text 文本内容
 ...
 */
HaloVoteCard.prototype.onLoad = function () {
  // 可以获取媒体 context 对象等
}
 ...
 */
HaloVoteCard.prototype.onDetached = function () {
  // 可以释放一些必要的资源（计时器等）
}

module.exports = HaloVoteCard
